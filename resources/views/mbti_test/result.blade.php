...
<body
    ...
    <div class="bg-white shadow-2xl rounded-3xl max-w-3xl w-full p-10 prose prose-purple">
        ...
        <div class="mt-2 leading-relaxed text-gray-800">
            ...
            <ul class="list-disc list-inside space-y-2">
                ...
                <li>
                    <a href="{{ route('articles.show', $article->id) }}" class="text-purple-600 hover:underline">
                        {{ $article->title }}
                    </a>
                    <p class="text-sm text-gray-600">{{ Str::limit($article->summary ?? '', 100) }}</p>
                </li>
                @endforeach
            </ul>
            @else
    ...
    <div class="bg-white shadow-2xl rounded-3xl max-w-3xl w-full p-10 prose prose-purple text-center">
        <h1 class="text-3xl font-extrabold mb-6 tracking-wide drop-shadow-md">Anda harus melakukan tes MBTI dulu!</h1>
