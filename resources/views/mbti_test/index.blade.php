...
<body
    ...
    @if (Auth::user()->role === 'user')
        <body
            class="text-gray-900 bg-gradient-to-br from-purple-50 via-white to-purple-50 min-h-screen font-sans antialiased">
            <form action="{{ route('mbti_test.store') }}" method="post"
                ...
                <div id="cardsWrapper" class="space-y-12">
                    ...
                    <div id="card-0" class="card bg-white rounded-3xl shadow-xl p-10 space-y-8 border border-purple-200">
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">4. Saya sering memikirkan kemungkinan masa depan
                                daripada
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">5. Saya membuat keputusan berdasarkan analisis logis
                                dan
                                objektif</p>
                            <div class="flex space-x-3 mt-2">
                                @foreach (['sangat_tidak_setuju', 'tidak_setuju', 'neutral', 'setuju', 'sangat_setuju'] as $j => $label)
                    ...
                    <div id="card-1"
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">6. Saya mempertimbangkan perasaan orang lain saat
                                membuat
                                keputusan</p>
                            <div class="flex space-x-3 mt-2">
                                @foreach (['sangat_tidak_setuju', 'tidak_setuju', 'neutral', 'setuju', 'sangat_setuju'] as $j => $label)
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">7. Saya suka membuat rencana dan mengikuti jadwal
                                yang
                                ketat</p>
                            <div class="flex space-x-3 mt-2">
                                @foreach (['sangat_tidak_setuju', 'tidak_setuju', 'neutral', 'setuju', 'sangat_setuju'] as $j => $label)
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">8. Saya lebih suka tetap fleksibel dan menyesuaikan
                                diri
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">10. Apakah kamu lebih suka bekerja di perusahaan
                                besar,
                    ...
                    <div id="card-3"
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">11. Seberapa penting bagi kamu untuk bekerja di
                                bidang
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">12. Apakah kamu ingin pekerjaan yang memungkinkan
                                kamu
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">14. Apakah kamu tertarik bekerja di sektor yang
                                mendukung
                        ...
                        <div>
                            <p class="font-medium text-gray-700 mb-3">15. Seberapa besar kamu ingin bisnis atau pekerjaanmu
                                di
                    ...
                    <div id="card-submit"
                        ...
                        <p class="text-gray-700">Terima kasih telah menyelesaikan tes kepribadian. Klik tombol di bawah
                            untuk
    ...
    <script>
        ...
        prevBtn.addEventListener('click', () => {
            if (current > 0) {
                showCard(current - 1); // previous normal
            }
        });
