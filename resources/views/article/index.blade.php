            ...
            <a href="{{ route('article.show', $article->hashid) }}" class="block">
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-gray-600 text-sm mb-3 line-clamp-3">{{ Str::limit($article->content, 100) }}</p>
                        <div class="flex justify-between items-center">
                            <span class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</span>
                        </div>
                    </div>
                </div>
            </a>
