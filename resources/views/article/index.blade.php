...
<body class="text-gray-800">
    ...
    <section class="relative py-12 md:py-20 bg-gradient-to-b from-white to-indigo-50 overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto flex flex-col items-center justify-center text-center px-4 relative z-10">
            ...
            <div class="mt-8 relative">
                ...
                <div class="absolute -top-4 -left-4 w-8 h-8 bg-indigo-100 rounded-lg flex items-center justify-center animate-bounce">
                    <svg class="w-4 h-4 text-indigo-600" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                </div>
                <div class="absolute -top-2 -right-6 w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center animate-pulse">
                    <svg class="w-3 h-3 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                    </svg>
                </div>
                <div class="absolute -bottom-3 -left-2 w-7 h-7 bg-purple-100 rounded-lg flex items-center justify-center animate-bounce" style="animation-delay: 0.5s">
                    <svg class="w-4 h-4 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"/>
                    </svg>
                </div>
                <img src="{{ asset('assets/article/artikel_dashboard.png') }}" alt="Mockup" class="w-80 md:w-96 mx-auto">
            </div>
        </div>
        <div class="pointer-events-none absolute inset-x-0 bottom-0 h-32 md:h-40 bg-gradient-to-t from-indigo-200/80 via-indigo-300/40 to-transparent"></div>
    </section>
    ...
    <section class="max-w-6xl mx-auto px-4 py-12">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <div class="flex items-center mb-6">
                <span class="bg-indigo-100 text-indigo-600 px-3 py-1 rounded-full text-sm font-medium mr-4">Artikel Terbaru</span>
                <h2 class="text-xl font-semibold">Bagaimana memilih Universitas yang tepat ?</h2>
            </div>
            <div class="grid md:grid-cols-2 gap-8 items-center">
                <div>
                    <img src="{{ asset('assets/article/artikel_terbaru.png') }}" alt="Article Image" class="w-full h-64 object-cover rounded-lg">
                </div>
                <div>
                    <p class="text-gray-600 mb-4 leading-relaxed">
                        Memilih universitas adalah keputusan penting yang memerlukan pertimbangan matang. Artikel ini membahas faktor-faktor penting yang perlu dipertimbangkan seperti akreditasi, fasilitas, biaya kuliah, dan prospek karir lulusan.
                    </p>
    ...
    <section class="max-w-6xl mx-auto px-4 py-12">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_bekerja1.png') }}" alt="Tips Pelaporan Jasa Keterampilan Digital dan Prestasi Usaha" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Tips Pelaporan Jasa Keterampilan Digital dan Prestasi Usaha</h3>
                    <p class="text-gray-600 text-sm mb-3">Dalam era digital saat ini, banyak peluang untuk mengembangkan keterampilan digital dan membangun prestasi usaha...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_bekerja2.png') }}" alt="Tips Sukses Negosiasi Gaji untuk Fresh Graduate" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Tips Sukses Negosiasi Gaji untuk Fresh Graduate</h3>
                    <p class="text-gray-600 text-sm mb-3">Negosiasi gaji merupakan skill penting yang harus dikuasai oleh fresh graduate...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_bekerja3.png') }}" alt="Industri Kreatif Peluang Besar bagi Generasi Milenial" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Industri Kreatif Peluang Besar bagi Generasi Milenial</h3>
                    <p class="text-gray-600 text-sm mb-3">Industri kreatif menawarkan peluang besar bagi generasi milenial untuk mengembangkan karir...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_bekerja4.png') }}" alt="Pelatihan Hybrid Solusi Baru bagi Karyawan Masa Kini Hidup" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Pelatihan Hybrid Solusi Baru bagi Karyawan Masa Kini Hidup</h3>
                    <p class="text-gray-600 text-sm mb-3">Pelatihan hybrid menjadi solusi inovatif untuk pengembangan karyawan di era modern...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
    ...
    <section class="max-w-6xl mx-auto px-4 py-12">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_studi1.png') }}" alt="Bagaimana Memilih Jurusan Wajib di Universitas" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Bagaimana Memilih Jurusan Wajib di Universitas</h3>
                    <p class="text-gray-600 text-sm mb-3">Memilih jurusan yang tepat adalah keputusan penting dalam hidup. Artikel ini memberikan panduan lengkap...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_studi2.png') }}" alt="Mengenal Teknologi Curriculum & Assessment" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Mengenal Teknologi Curriculum & Assessment</h3>
                    <p class="text-gray-600 text-sm mb-3">Teknologi dalam pendidikan terus berkembang. Pelajari bagaimana curriculum dan assessment modern...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_studi3.png') }}" alt="S-2 Cara Menyiapkan Passion untuk Akademik" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">S-2 Cara Menyiapkan Passion untuk Akademik</h3>
                    <p class="text-gray-600 text-sm mb-3">Melanjutkan studi S-2 membutuhkan persiapan yang matang. Temukan cara untuk menyiapkan passion...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_studi4.png') }}" alt="Kuliah Masuk Kuliah di UGM" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Kuliah Masuk Kuliah di UGM</h3>
                    <p class="text-gray-600 text-sm mb-3">UGM merupakan salah satu universitas terbaik di Indonesia. Pelajari tips dan strategi untuk bisa diterima...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
    ...
    <section class="max-w-6xl mx-auto px-4 py-12">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_wirausaha1.png') }}" alt="Strategi Pemasaran Digital untuk UMKM" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Strategi Pemasaran Digital untuk UMKM</h3>
                    <p class="text-gray-600 text-sm mb-3">Pemasaran digital menjadi kunci sukses UMKM di era modern. Pelajari strategi-strategi efektif...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_wirausaha2.png') }}" alt="Mengelola Pemerintahan Crowdfunding untuk Startup" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Mengelola Pemerintahan Crowdfunding untuk Startup</h3>
                    <p class="text-gray-600 text-sm mb-3">Crowdfunding menjadi alternatif pendanaan yang populer untuk startup. Pelajari cara mengelola kampanye...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_wirausaha3.png') }}" alt="5 Kesalahan Umum yang Harus Dihindari" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">5 Kesalahan Umum yang Harus Dihindari</h3>
                    <p class="text-gray-600 text-sm mb-3">Dalam memulai bisnis, ada beberapa kesalahan umum yang sering dilakukan entrepreneur pemula...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <img src="{{ asset('assets/article/artikel_wirausaha4.png') }}" alt="Pentingnya Branding bagi Bisnis Kecil" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="font-semibold text-lg mb-2">Pentingnya Branding bagi Bisnis Kecil</h3>
                    <p class="text-gray-600 text-sm mb-3">Branding bukan hanya untuk perusahaan besar. Bisnis kecil juga membutuhkan branding yang kuat...</p>
                    <div class="flex justify-between items-center">
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Baca Selengkapnya</a>
                    </div>
                </div>
    ...
    <section class="bg-indigo-50 py-16">
        <div class="max-w-4xl mx-auto px-4">
            <div class="flex items-center mb-8">
                <img src="{{ asset('assets/article/pertanyaan_artikel.png') }}" alt="FAQ Image" class="w-32 h-32 object-cover rounded-lg mr-8">
                <div>
            ...
            <div class="space-y-4" x-data="{ openIndex: null }">
                @php
                    $faqs = [
                        ...
                        ['question' => 'Bagaimana saya Kangru membantu saya menentukan karir?', 'answer' => 'Kangru memberikan rekomendasi karir yang dipersonalisasi berdasarkan analisis kepribadian dan minat Anda.'],
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-600 text-sm">
                        ...
                        <li><a href="https://github.com/rafidhp/kangru" target="_blank" class="hover:text-indigo-600">Github</a></li>
                    </ul>
                </div>
            </div>
            <div class="mt-8 border-t border-gray-200 pt-6 flex flex-col md:flex-row items-center justify-between text-gray-500 text-xs">
                ...
                <div class="flex space-x-4 mt-4 md:mt-0">
                    <a href="https://github.com/rafidhp/kangru" target="_blank" class="hover:text-indigo-600">Support</a>
