...
<body class="min-h-screen bg-gradient-to-r from-indigo-900 via-blue-900 to-blue-800 flex items-center justify-center">
    <div class="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg bg-white rounded-2xl shadow-2xl p-6 md:p-10 wavy-bg relative">
        <img
            ...
            <form class="space-y-6" action="{{ route('auth.postlogin') }}" method="POST" novalidate>
                ...
                <div class="relative">
                    ...
                    <button type="button" tabindex="-1"
                        ...
                        <svg id="eyeIconLogin" class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2"
