...
<body class="min-h-screen bg-gradient-to-r from-indigo-900 via-blue-900 to-blue-800 flex items-center justify-center">
    <div
        class="w-full max-w-7xl xl:max-w-6xl 2xl:max-w-7xl bg-white/10 rounded-[20px] shadow-2xl flex flex-col-reverse xl:flex-row overflow-hidden mx-4">
        <img src="{{ asset('assets/img/auth_bg.jpg') }}"
    ...
    <div x-data="{ showLogin: true }" class="flex items-center justify-center min-h-screen absolute inset-0 z-20">
        <!-- Login Card -->
        <div x-show="showLogin" x-transition:enter="transition transform duration-500"
            x-transition:enter-start="scale-90 opacity-0" x-transition:enter-end="scale-100 opacity-100"
            x-transition:leave="transition transform duration-500" x-transition:leave-start="scale-100 opacity-100"
            ...
            <div class="relative z-10">
                ...
                <svg class="h-10 w-10 mx-auto mb-4" viewBox="0 0 64 64" fill="none"
                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path d="M22 46c0-14 10-20 19-20" stroke="#4B4A82" stroke-width="4" stroke-linecap="round"
                ...
                <div class="mt-6 text-center">
                    <button type="button"
                        ...
                        <svg class="w-5 h-5" viewBox="0 0 533.5 544.3" xmlns="http://www.w3.org/2000/svg"
                            aria-hidden="true">
                            <path
                                d="M533.5 278.4c0-18.6-1.6-37.2-4.8-55.2H272v104.5h146.9c-6.3 33.7-25 62.3-53.3 81.5v67h85.9c50.2-46.3 81.9-114.5 81.9-197.8z"
                                fill="#4285f4" />
                            <path
                                d="M272 544.3c72.6 0 133.5-24 178-65.1l-85.9-67c-23.8 16-54.2 25-92.1 25-70.8 0-130.8-47.9-152.3-112.1H30.4v70.6C74.2 477 166.8 544.3 272 544.3z"
                                fill="#34a853" />
                            <path
                                d="M119.7 324.9c-5.6-16.7-8.8-34.5-8.8-52.9s3.2-36.2 8.8-52.9v-70.6H30.4C11 189.2 0 228.2 0 272c0 43.8 11 82.8 30.4 122.4l89.3-69.5z"
                                fill="#fbbc04" />
                            <path
                                d="M272 107.7c39.5 0 74.8 13.6 102.6 40.3l76.8-76.8C405.5 26.7 344.6 0 272 0 166.8 0 74.2 67.3 30.4 149.6l89.3 70.6C141.2 155.6 201.2 107.7 272 107.7z"
                                fill="#ea4335" />
                        </svg>
                        Masuk dengan Google
                    </button>
    ...
    <script>
        function togglePasswordVisibility() {
            ...
            if (pwdInput.type === 'password') {
                pwdInput.type = 'text';
                eyeIcon.innerHTML =
                    '<path d="M17.94 17.94a10.12 10.12 0 0 1-5.94 2.59C6 20.62 1 12 1 12s2.5-4.69 6.42-7.12M12 7v5l4 4"/>';
            } else {
