    ...
    <section class="max-w-6xl mx-auto px-4 md:px-0 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
            ...
            <p class="mb-6 text-gray-600 text-lg leading-relaxed">
                Lebih dari sekadar aplikasi karir. Dengan AI dan MBTI, Kangru memberikan rekomendasi rencana pribadi sesuai minat, bakat, dan impianmu: Bekerja, Studi, atau Wirausaha.
            </p>
        ...
        <div class="bg-white/80 shadow-xl rounded-2xl p-8 flex flex-col items-center">
            ...
            <p class="mb-6 text-gray-500 text-center">Kangru terhubung dengan aplikasi populer untuk mendukung perjalanan karirmu.</p>
        ...
        <div class="md:col-start-2 flex items-center justify-center -mt-8">
            <div class="relative bg-indigo-600 rounded-2xl shadow-xl p-8 flex flex-col items-center text-white overflow-hidden w-full">
                ...
                <div class="flex flex-col items-center z-10">
                    ...
                    <span class="text-lg md:text-xl font-medium text-indigo-100 text-center">pengguna aktif di seluruh dunia</span>
                </div>
            </div>
        </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-center gap-6">
                <div class="flex-1 bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center hover:scale-105 transition-transform duration-200 border-2 border-transparent hover:border-indigo-200">
                    <div class="bg-indigo-100 rounded-full p-4 mb-4">
                        <svg class="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87M16 3.13a4 4 0 010 7.75M8 3.13a4 4 0 000 7.75" /></svg>
                    </div>
                    <h3 class="font-semibold text-xl mb-2 text-indigo-700">Bekerja</h3>
                    <p class="text-gray-500 mb-4">Dapatkan rekomendasi pekerjaan, tips CV, dan simulasi interview dari para ahli.</p>
                    <button class="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2 rounded-lg font-medium transition">Pilih Jalur Ini</button>
                </div>
                <div class="flex-1 bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center hover:scale-105 transition-transform duration-200 border-2 border-transparent hover:border-indigo-200">
                    <div class="bg-indigo-100 rounded-full p-4 mb-4">
                        <svg class="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 14l9-5-9-5-9 5 9 5zm0 7v-6m0 0l-7-4m7 4l7-4" /></svg>
                    </div>
                    <h3 class="font-semibold text-xl mb-2 text-indigo-700">Melanjutkan Studi</h3>
                    <p class="text-gray-500 mb-4">Temukan kampus dan jurusan terbaik, serta tips beasiswa dan persiapan studi lanjut.</p>
                    <button class="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2 rounded-lg font-medium transition">Pilih Jalur Ini</button>
                </div>
                <div class="flex-1 bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center hover:scale-105 transition-transform duration-200 border-2 border-transparent hover:border-indigo-200">
                    <div class="bg-indigo-100 rounded-full p-4 mb-4">
                        <svg class="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 00-3-3.87M4 21v-2a4 4 0 013-3.87M12 7V3m0 0L8.5 7.5M12 3l3.5 4.5" /></svg>
                    </div>
                    <h3 class="font-semibold text-xl mb-2 text-indigo-700">Wirausaha</h3>
                    <p class="text-gray-500 mb-4">Dapatkan inspirasi bisnis, panduan memulai usaha, dan mentoring dari entrepreneur sukses.</p>
                    <button class="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2 rounded-lg font-medium transition">Pilih Jalur Ini</button>
                </div>
            </div>
        </div>
    ...
    <section class="max-w-6xl mx-auto py-16 px-4">
        ...
        <div class="grid md:grid-cols-4 gap-8">
            <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center hover:shadow-xl transition">
                <img src="{{ asset('assets/Sultang.png') }}" class="mb-4 rounded-full h-24 w-24 object-cover border-4 border-indigo-100 shadow">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center hover:shadow-xl transition">
                <img src="{{ asset('assets/aper.png') }}" class="mb-4 rounded-full h-24 w-24 object-cover border-4 border-indigo-100 shadow">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center hover:shadow-xl transition">
                <img src="{{ asset('assets/pagun.png') }}" class="mb-4 rounded-full h-24 w-24 object-cover border-4 border-indigo-100 shadow">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center hover:shadow-xl transition">
                <img src="{{ asset('assets/nanda.png') }}" class="mb-4 rounded-full h-24 w-24 object-cover border-4 border-indigo-100 shadow">
    ...
    <section class="max-w-4xl mx-auto py-16 px-4" x-data="{ openIndex: null }">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <template x-for="(faq, index) in [
                ...
                <div class="border rounded-lg p-4 cursor-pointer select-none hover:shadow-lg transition-shadow duration-300" @click="openIndex === index ? openIndex = null : openIndex = index">
                    <div class="flex justify-between items-center">
                        <h3 class="font-semibold text-gray-800" x-text="faq.question"></h3>
                        <button class="text-indigo-600 font-bold text-xl leading-none focus:outline-none" :aria-expanded="openIndex === index" :aria-controls="'faq-answer-' + index" type="button" @click.stop="openIndex === index ? openIndex = null : openIndex = index" x-text="openIndex === index ? '-' : '+'"></button>
                    </div>
                    <div class="mt-2 text-gray-600" x-show="openIndex === index" x-transition x-bind:id="'faq-answer-' + index" x-cloak x-text="faq.answer"></div>
                </div>
            </template>
        </div>
    </section>
