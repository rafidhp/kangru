...
<head>
    ...
    <title>Register Advertiser | Kangru</title>
    ...
    <div
        ...
        <div class="relative z-10">
            ...
            <form class="space-y-6" action="{{ route('advertiser.postregister') }}" method="post"
                ...
                <div>
                    <label for="instansi" class="block text-sm font-medium text-gray-700">Nama Instansi</label>
                    <input id="instansi" name="instansi" type="text" required value="{{ old('instansi') }}"
                        class="mt-1 block w-full border-b border-gray-300 focus:border-indigo-600 focus:ring-0 focus:outline-none placeholder-gray-400 text-gray-900 bg-transparent pb-1"
                ...
                <div>
                    ...
                    <input id="no_telepon" name="no_telepon" type="integer" required value="{{ old('no_telepon') }}"
                        class="mt-1 block w-full border-b border-gray-300 focus:border-indigo-600 focus:ring-0 focus:outline-none placeholder-gray-400 text-gray-900 bg-transparent pb-1"
                ...
                <div>
                    <label for="NPWP/SIUP" class="block text-sm font-medium text-gray-700">NPWP/SIUP</label>
                    <input id="NPWP/SIUP" name="NPWP/SIUP" type="file" accept=".pdf" required
                        class="mt-1 block w-full text-gray-900
                            file:bg-transparent file:border-0
                            file:mr-4 file:py-1 file:px-2
                            file:text-sm file:font-medium
                            focus:border-indigo-600 focus:ring-0 focus:outline-none
